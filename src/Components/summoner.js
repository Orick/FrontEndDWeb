...
class Summoner extends Component {
    ...
    async getChamptionLink(idChamp){
        return new Promise((resolve,reject)=> {
            fetch('http://' + localhost + '/champions/imagen/'+idChamp)
            .then(res => res.json())
            .then(result => {
    ...
    serguirSummoner(summonerId){
        ...
        if (user) {
            ...
            .then(Token =>{
                fetch('http://' + localhost + '/assocciatedAccounts/assig',{
                    method: 'POST',
